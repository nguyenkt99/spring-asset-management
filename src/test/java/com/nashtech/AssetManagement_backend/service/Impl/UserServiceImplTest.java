...
//                new Date(), Location.HCM,true,role,null,null,null);
//        users = Stream.of(user1,user2).collect(Collectors.toList());
//
//
//        rolesEntity.setId(1L);
//        rolesEntity.setName(RoleName.ROLE_STAFF);
...
//        dto.setType(RoleName.ROLE_STAFF);
//
...
//
//    @Test
//    void canDisableUser_then_return_instance_of_boolean(){
//        UsersEntity users = new UsersEntity();
//        Mockito.when(userRepository.findByStaffCode(Mockito.anyString())).thenReturn(Optional.of(users));
//        assertTrue(userService.canDisableUser(Mockito.anyString()));
//    }
//
...
//
//    @Test
//    void canDisable_user_when_staffCode_not_exist_and_throw_not_found_exception(){
//        Mockito.when(userRepository.findByStaffCode(Mockito.anyString())).thenReturn(Optional.empty());
//        Exception exception = assertThrows(ResourceNotFoundException.class, () -> userService.canDisableUser(Mockito.anyString()));
//        assertEquals(exception.getMessage(),USER_NOT_FOUND);
//    }
//
//    @Test
//    void disableUser_when_staffCode_not_exist_then_throw_not_found_exception(){
//        Mockito.when(userRepository.findByStaffCode(Mockito.anyString())).thenReturn(Optional.empty());
//        Exception exception = assertThrows(ResourceNotFoundException.class, ()-> userService.canDisableUser(Mockito.anyString()));
//        assertEquals(exception.getMessage(), USER_NOT_FOUND);
//    }
//
//    @Test
//    void disableUser_when_has_assignment_then_throw_conflict_exception(){
//        UsersEntity users = new UsersEntity();
//        users.setAssignmentTos(Arrays.asList(new AssignmentEntity(), new AssignmentEntity()));
//        Mockito.when(userRepository.findByStaffCode(Mockito.anyString())).thenReturn(Optional.of(users));
//        Exception exception = assertThrows(ConflictException.class,() -> userService.disableUser(Mockito.anyString()));
//        assertEquals(exception.getMessage(), DISABLE_CONFLICT);
//    }
//
//    @Test
//    void disableUser_then_true(){
//        UsersEntity users = new UsersEntity();
//        Mockito.when(userRepository.findByStaffCode(Mockito.anyString())).thenReturn(Optional.of(users));
//        assertTrue(userService.disableUser(Mockito.anyString()));
//    }
//}